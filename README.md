...
Перейти на главную страницу <a href="https://netology.ru">Нетология</a>
...
1. Перейти на страницу для записи на курс <a href="https://netology.ru/programs/qa">"Тестировщик"</a>
2. Найти кнопку "Записаться" и кликнуть по ней.
3. Убедиться, что отрывается форма регистрации на курс.
